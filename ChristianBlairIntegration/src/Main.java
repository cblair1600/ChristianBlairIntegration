...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("There are " + apples + " pounds of apples on a scale");
        System.out.println("Then someone adds a few bananas, making the weight ");
        ...
        System.out.println(" ");
        System.out.println("Would you like to view the string builder example, creating a number of ip addresses?");
